...
- **Profile management** — create, edit, rename, and delete proxy configurations
...
- **Auto backup** — profiles are backed up to `~/.claude/backups/` before any destructive operation
...
4. Press **Enter** on any profile to switch to it
   在任意配置上按 **Enter** 即可切换
